                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse($orders as $index => $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-black-800">{{ $order->quantity }}</span>
                                            </td>
                                            <td class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-black-800">{{ $order->total_price }}</span>
                                            </td>
                                            <td class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-black-800">{{ $order->status }}</span>
                                            </td>
